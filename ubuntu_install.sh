...
sudo ./gluster-object/gluster-object-transit/store_user_info.py
sudo ./gluster-object/gluster-object-transit/clean-auth-vol.py
...
cd ..
sudo ./gluster-object/gluster-object-transit/prepare-restore-ufo-env.py
